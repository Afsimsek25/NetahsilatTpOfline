 ...
 * Generated on Sun Oct 09 20:43:24 GMT 2022.
 */
@DisplayName("C3255")
public class C3255 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Is 'KART KAYDETME LINKI LISTELEME1' visible?
    ...
    // 8. Click 'ÜYE YÖNETİMİ1'
    by = By.xpath("//li[1]/a[. = 'ÜYE YÖNETİMİ']");
    driver.findElement(by).click();

    // 9. Type 'netahsilatotomasyon@yandex.com' in 'SearchVendorName'
    ...
    // 19. Run Clear 'SearchVendorName' contents and type 'bireyselanabayi@otomasyon.com'
    ...
    // 25. Is 'Bireysel Ana Bayi (Silmeyiniz-Değişti...' visible?
    by = By.xpath("//strong[. = 'Bireysel Ana Bayi (Silmeyiniz-Değiştirmeyiniz)']");
    driver.findElement(by).isDisplayed();

    // 26. Is 'KART KAYDI LİNKİ' visible?
    by = By.xpath("//a[. = 'KART KAYDI LİNKİ']");
    driver.findElement(by).isDisplayed();

    // 27. Switch to window '0'
    driver.switchTo().window(driver.getWindowHandles().toArray(new String[0])[0]);

    // 28. Close the last tab opened in the browser
    closeLastTab = TabActions.getCloseLastTab();
    closeLastTab = (TabActions.CloseLastTab)((ReportingDriver)driver).addons().execute(closeLastTab);

    // 29. Run Clear 'SearchVendorName' contents and type 'bireyselaltbayi@otomasyon.com'
    clearAndTypeAction = CombinedActions.clearAndTypeAction("bireyselaltbayi@otomasyon.com");
    by = By.cssSelector("#SearchVendorName");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 30. Click 'resultListelenen'
    by = By.xpath("//body/ul//div");
    driver.findElement(by).click();
    ...
    // 35. Is 'Bireysel Alt Bayi (Silmeyiniz-Değişti...' visible?
    by = By.xpath("//strong[. = 'Bireysel Alt Bayi (Silmeyiniz-Değiştirmeyiniz)']");
    driver.findElement(by).isDisplayed();

    // 36. Is 'KART KAYDI LİNKİ' visible?
    by = By.xpath("//a[. = 'KART KAYDI LİNKİ']");
    driver.findElement(by).isDisplayed();
    ...
    // 38. Close the last tab opened in the browser
    closeLastTab = TabActions.getCloseLastTab();
    closeLastTab = (TabActions.CloseLastTab)((ReportingDriver)driver).addons().execute(closeLastTab);

    // 39. Run Clear 'SearchVendorName' contents and type 'bireyselaltmusteri@otomasyon.com'
    clearAndTypeAction = CombinedActions.clearAndTypeAction("bireyselaltmusteri@otomasyon.com");
    by = By.cssSelector("#SearchVendorName");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 40. Click 'resultListelenen'
    by = By.xpath("//body/ul//div");
    driver.findElement(by).click();
    ...
    // 45. Is 'Bireysel Alt Müşteri (Silmeyiniz-Deği...' visible?
    by = By.xpath("//strong[. = 'Bireysel Alt Müşteri  (Silmeyiniz-Değiştirmeyiniz)']");
    driver.findElement(by).isDisplayed();

    // 46. Is 'KART KAYDI LİNKİ' visible?
    by = By.xpath("//a[. = 'KART KAYDI LİNKİ']");
    driver.findElement(by).isDisplayed();
