 ...
 * Test: C5236 Alt Müşteri olarak giriş yapılıp kendi bilgileri güncelleniyor mu ?
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 06:57:09 GMT 2022.
 */
@DisplayName("C5236 Alt Müşteri olarak giriş yapılıp kendi bilgileri güncelleniyor mu ?")
public class C5236 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password) throws Exception {
    ...
    methodlogoutlogin.userName = "altmusteriguncellenecek@test.com";
    methodlogoutlogin.password = ProjectParameters.genelPassword;
    methodlogoutlogin.execute(driver);

    // 2. Click 'Bilgi Güncelle'
    GeneratedUtils.sleep(500);
    by = By.xpath("//a[. = 'Bilgi Güncelle']");
    driver.findElement(by).click();

    // 3. Run Clear 'Name' contents and type 'C5236 Müşteri1'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("C5236 Müşteri1");
    ...
    // 10. Type 'C5236 Müşteri1' in 'CompanyName'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#CompanyName");
    driver.findElement(by).sendKeys("C5236 Müşteri1");

    // 11. Type 'Meram' in 'TaxOffice'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#TaxOffice");
    driver.findElement(by).sendKeys("Meram");

    // 12. Type '7410927065' in 'TaxNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#TaxNumber");
    driver.findElement(by).sendKeys("7410927065");

    // 13. Run Clear 'Email1' contents and type 'altmusteriguncellendi@test.com'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("altmusteriguncellendi@test.com");
    by = By.cssSelector("#Email");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 14. Run Clear 'AddressModel_Address' contents and type 'meram/konya'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("meram/konya");
    by = By.cssSelector("#AddressModel_Address");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 15. Select the '42' option in 'AddressModel_CityId'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AddressModel_CityId");
    (new Select(driver.findElement(by))).selectByValue("42");

    // 16. Select the '868' option in 'AddressModel_DistrictId'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AddressModel_DistrictId");
    (new Select(driver.findElement(by))).selectByValue("868");

    // 17. Select options in 'AddressModel_NeighborhoodId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    methodlogin.userName = "altmusteriguncellendi@test.com";
    methodlogin.password = String.format("%s1",password);
    methodlogin.execute(driver);

    // 23. Click 'Bilgi Güncelle'
    GeneratedUtils.sleep(500);
    by = By.xpath("//a[. = 'Bilgi Güncelle']");
    driver.findElement(by).click();

    // 24. Does 'Name' contain 'C5236 Müşteri1'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#Name");
    Assertions.assertTrue(driver.findElement(by).getText().contains("C5236 Müşteri1"));
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);

    // 25. Does 'Surname' contain 'güncellendi'?
    // set step-specific timeout (will undo this at the end)
    ...
    // 27. Does 'ContactModel_Phone2Number' contain '(540)0000001'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#ContactModel_Phone2Number");
    ...
    // 29. Does 'ContactModel_Fax1Number' contain '(511)1111112'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#ContactModel_Fax1Number");
    ...
    // 30. Does 'CompanyName' contain 'C5236 Müşteri1'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#CompanyName");
    Assertions.assertTrue(driver.findElement(by).getText().contains("C5236 Müşteri1"));
    ...
    // 31. Does 'ContactModel_GsmNumber' contain '(522)2222223'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#ContactModel_GsmNumber");
    ...
    // 32. Does 'TaxOffice' contain 'Meram'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#TaxOffice");
    ...
    // 33. Does 'AddressModel_Address' contain 'meram/konya'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#AddressModel_Address");
    ...
    // 34. Does 'TaxNumber' contain '7410927065'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#TaxNumber");
    Assertions.assertTrue(driver.findElement(by).getText().contains("7410927065"));
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);

    // 35. Does 'AddressModel_CityId' contain 'Konya'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#AddressModel_CityId");
    ...
    // 36. Does 'Email1' contain 'altmusteriguncellendi@test.com'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#Email");
    Assertions.assertTrue(driver.findElement(by).getText().contains("altmusteriguncellendi@test.com"));
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);

    // 37. Does 'AddressModel_DistrictId' contain 'Meram'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#AddressModel_DistrictId");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Meram"));
    ...
    // 38. Does 'AddressModel_NeighborhoodId' contain 'Meram'?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#AddressModel_NeighborhoodId");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Meram"));
    ...
    // 39. Run Clear 'Name' contents and type 'C5236 Müşteri'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("C5236 Müşteri");
    by = By.cssSelector("#Name");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 40. Run Clear 'Surname' contents and type 'güncellenecek'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("güncellenecek");
    by = By.cssSelector("#Surname");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 41. Run Clear 'ContactModel_Phone1Number' contents and type '5000000000'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("5000000000");
    by = By.cssSelector("#ContactModel_Phone1Number");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 42. Run Clear 'ContactModel_Phone2Number' contents and type '5400000000'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("5400000000");
    by = By.cssSelector("#ContactModel_Phone2Number");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 43. Run Clear 'ContactModel_Fax1Number' contents and type '5111111111'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("5111111111");
    by = By.cssSelector("#ContactModel_Fax1Number");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 44. Run Clear 'ContactModel_GsmNumber' contents and type '5222222222'
    GeneratedUtils.sleep(500);
    ...
    // 46. Run Clear 'Tckn' contents and type '61995471596'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("61995471596");
    by = By.cssSelector("#Tckn");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 47. Run Clear 'Email1' contents and type 'altmusteriguncellenecek@test.com'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("altmusteriguncellenecek@test.com");
    by = By.cssSelector("#Email");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 48. Run Clear 'AddressModel_Address' contents and type 'kartal/İstanbul'
    GeneratedUtils.sleep(500);
    clearAndTypeAction = CombinedActions.clearAndTypeAction("kartal/İstanbul");
    by = By.cssSelector("#AddressModel_Address");
    clearAndTypeAction = (CombinedActions.ClearAndTypeAction)((ReportingDriver)driver).addons().execute(clearAndTypeAction, by, -1);

    // 49. Select the '34' option in 'AddressModel_CityId'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AddressModel_CityId");
    (new Select(driver.findElement(by))).selectByValue("34");

    // 50. Select the '118' option in 'AddressModel_DistrictId'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AddressModel_DistrictId");
    (new Select(driver.findElement(by))).selectByValue("118");

    // 51. Select options in 'AddressModel_NeighborhoodId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Kartal");
    by = By.cssSelector("#AddressModel_NeighborhoodId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);

    // 52. Type 'Kd!cyhz41' in 'OldPassword'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#OldPassword");
    driver.findElement(by).sendKeys("Kd!cyhz41");

    // 53. Type 'Kd!cyhz4' in 'Password1'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#Password");
    driver.findElement(by).sendKeys("Kd!cyhz4");

    // 54. Type 'Kd!cyhz4' in 'RePassword'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#RePassword");
    driver.findElement(by).sendKeys("Kd!cyhz4");

    // 55. Click 'KaydetMusteri'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("input[value='KAYDET']");
    driver.findElement(by).click();
