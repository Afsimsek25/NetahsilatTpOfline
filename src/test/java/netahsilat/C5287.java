 ...
 * Test: C5287 Responsive ekranlarda işlemler listeleniyor mu ?(admin ödeme ekranına git)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 06:58:34 GMT 2022.
 */
@DisplayName("C5287 Responsive ekranlarda işlemler listeleniyor mu ?(admin ödeme ekranına git)")
public class C5287 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String butonlar, String password) throws Exception {
    ...
    // 6. Click 'İşlemler Mobil Gorunum'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(25000, TimeUnit.MILLISECONDS);
