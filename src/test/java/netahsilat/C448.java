 ...
 * Test: C448 Valör Tarihi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 15:53:46 GMT 2022.
 */
@DisplayName("C448 Valör Tarihi")
public class C448 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String today) throws
    ...
    // 9. Type '12.12.2020' in 'InstallmentStartDate'
    GeneratedUtils.sleep(500);
    ...
    // 11. Get text from 'InstallmentStartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#InstallmentStartDate");
    string = driver.findElement(by).getAttribute("value");
    Assertions.assertEquals("12.12.2020 00:00", string);

    // 12. Clear 'InstallmentStartDate' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#InstallmentStartDate");
    driver.findElement(by).clear();

    // 13. Type 'furkan' in 'InstallmentStartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#InstallmentStartDate");
    ...
    // 15. Get value of 'color' CSS property on 'InstallmentStartDate'
    GeneratedUtils.sleep(500);
    ...
    // 16. Clear 'InstallmentStartDate' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#InstallmentStartDate");
    driver.findElement(by).clear();

    // 17. Click 'Open the time view'
    GeneratedUtils.sleep(500);
