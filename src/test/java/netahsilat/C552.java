 ...
 * Test: C552 Date Time Kontrolü
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 08:04:30 GMT 2022.
 */
@DisplayName("C552 Date Time Kontrolü")
public class C552 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String today) throws
    ...
    // 5. Click 'valörOpenCalendar'
    GeneratedUtils.sleep(500);
    by = By.xpath("(//span[text()='Open the calendar'])[1]");
    driver.findElement(by).click();

    // 6. Get text from 'todayOnCalendar'
    GeneratedUtils.sleep(500);
    ...
    // 8. Type '12.12.2020' in 'RequestStartDate'
    GeneratedUtils.sleep(500);
    ...
    // 10. Get text from 'RequestStartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#RequestStartDate");
    string = driver.findElement(by).getAttribute("value");
    Assertions.assertEquals("12.12.2020 00:00", string);

    // 11. Clear 'RequestStartDate' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#RequestStartDate");
    driver.findElement(by).clear();

    // 12. Type 'furkan' in 'RequestStartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#RequestStartDate");
    ...
    // 14. Get value of 'color' CSS property on 'RequestStartDate'
    GeneratedUtils.sleep(500);
    ...
    // 15. Clear 'RequestStartDate' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#RequestStartDate");
    driver.findElement(by).clear();

    // 16. Click 'Open the time view'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[1]/fieldset/div[2]//span[. = 'Open the time view']");
    driver.findElement(by).click();

    // 17. List Elements Contains Text
    GeneratedUtils.sleep(500);
