 ...
 * Test: C1971 Excel ile site kullanıcı aktarımı - Country TR Değilse TCKN Zorunlu Olmamalı
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 10:35:12 GMT 2022.
 */
@DisplayName("C1971 Excel ile site kullanıcı aktarımı - Country TR Değilse TCKN Zorunlu Olmamalı")
public class C1971 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    GeneratedUtils.sleep(500);
    uploadFileElementAction = FileUpload.uploadFileElementAction("C:\\TestProject\\C1971.xlsx");
    ...
    // 11. Move mouse to 'moveToKullaniciYönetimi'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("li[class='user']");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 12. Click 'KULLANICI YÖNETİMİ1'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[title='KULLANICI YÖNETİMİ']");
    driver.findElement(by).click();

    // 13. Click 'KULLANICI LİSTESİ1'
    GeneratedUtils.sleep(500);
    by = By.xpath("//a[. = 'KULLANICI LİSTESİ']");
    driver.findElement(by).click();

    // 14. Type 'excel12@test.com' in 'inputEmailPricinPage'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#Email");
    driver.findElement(by).sendKeys("excel12@test.com");
    ...
    // 16. Is 'excel12@test.com' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[. = 'excel12@test.com']");
    driver.findElement(by).isDisplayed();

    // 17. Click 'buttonBayiSilme'
    GeneratedUtils.sleep(500);
    ...
    // 20. Does 'Gösterilecek Kayıt Bulunamadı.1' contain 'Gösterilecek Kayıt Bulunamadı.'?
    GeneratedUtils.sleep(500);
