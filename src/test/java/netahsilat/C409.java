 ...
 * Test: C409 IP İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Sep 29 12:15:14 GMT 2022.
 */
@DisplayName("C409 IP İle Listeleme")
public class C409 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Type '46.106.234.225' in 'UserIpAddress'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#UserIpAddress");
    driver.findElement(by).sendKeys("46.106.234.225");
    ...
    // 9. Does 'referansColumnIslemler' contain 'NT56154P0000013017'?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#VPosTransactionGrid > table > tbody > tr > td:nth-child(29)");
    Assertions.assertTrue(driver.findElement(by).getText().contains("NT56154P0000013017"));
