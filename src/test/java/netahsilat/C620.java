 ...
 * Test: C620 Ödeme Seti İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 06:37:53 GMT 2022.
 */
@DisplayName("C620 Ödeme Seti İle Listeleme")
public class C620 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String text) throws
      Exception {
    ...
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);
    */
    // 8. Is 'btnListele' is clickable?
    GeneratedUtils.sleep(500);
    by = By.xpath("//button[. = 'Listele']");
    (new WebDriverWait(driver, 15)).until(ExpectedConditions.elementToBeClickable(by));

    // 9. Get Data From Grid With Specific Locator
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    GeneratedUtils.sleep(500);
    getData = GetDataFromGridWithSpecificLocator.getData("div[class='t-widget t-grid'][id='VendorListGrid']","Ödeme Seti","Varsayılan ödeme seti","Equals");
