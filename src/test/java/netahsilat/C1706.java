 ...
 * Test: C1706 Altbayi login olup ödeme yapma
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:22:14 GMT 2022.
 */
@DisplayName("C1706 Altbayi login olup ödeme yapma")
public class C1706 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String RandomTutar1,
    ...
    // 11. Move mouse to 'btnNormalPayment'
    by = By.cssSelector("#btnNormalPayment");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 12. Click 'btnNormalPayment'
    by = By.cssSelector("#btnNormalPayment");
    driver.findElement(by).click();

    // 13. Is 'Payment Efekti' visible?
    by = By.cssSelector("div[class='spinner']");
    driver.findElement(by).isDisplayed();

    // 14. Get text from 'txtReferansNumarasi'
    ...
    // 15. Get substring of '{{ReferansNumber}}' from '42' to '[NONE]'
    ...
    // 16. Run Method Vakıfbank İşlem Durumu Sorgulama
