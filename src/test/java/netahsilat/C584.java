 ...
 * Test: C584 Excel'e Aktar
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 08:37:12 GMT 2022.
 */
@DisplayName("C584 Excel'e Aktar")
public class C584 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String gridHeaders,
      String excelColumnsNames) throws Exception {
    ...
    //    C:\Users\testortak\Downloads\Ödeme Kalemleri.xls
    GeneratedUtils.sleep(500);
    deleteFile = CommunityExcelActionsforWindows.deleteFile("%USERPROFILE%\\Downloads\\Ödeme Kalemleri.xls");
    ...
    //    %USERPROFILE%\Downloads\Ödeme Kalemleri.xls
    GeneratedUtils.sleep(500);
    waitUntilFileDownloaded = CommunityExcelActionsforWindows.waitUntilFileDownloaded("%USERPROFILE%\\Downloads\\Ödeme Kalemleri.xls",30);
    ...
    // 8. Read Excel Row
    GeneratedUtils.sleep(500);
    readRowValue = CommunityExcelActionsforWindows.readRowValue("%USERPROFILE%\\Downloads\\Ödeme Kalemleri.xls",1,1);
