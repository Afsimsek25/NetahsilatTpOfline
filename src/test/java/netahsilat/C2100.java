 ...
 * Test: C2100 Ödeme Talimat Formu - Bayi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 11:14:09 GMT 2022.
 */
@DisplayName("C2100 Ödeme Talimat Formu - Bayi")
public class C2100 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String kartNo, String CVV,
    ...
    // 7. Click 'Bayi (Unchecked) -Ödeme Talimat Formu' if it's visible
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
    GeneratedUtils.sleep(500);
    ...
    //    Ödeme Talimatı Oluştur butonunun gelmediği teyit edilir.
    // set step-specific timeout (will undo this at the end)
    ...
    //    Ödeme Talimat Form'unun gelmediği teyit edilir.
    GeneratedUtils.sleep(500);
    ...
    //    Ödeme Yap butonunun görünür olduğu teyit edilir.
    GeneratedUtils.sleep(500);
    ...
    // 21. Click 'Bayi (Checked) - Ödeme Talimat Formu'
    GeneratedUtils.sleep(500);
    ...
    // 30. Click 'genelOdemeTaksitSecenegi'
    GeneratedUtils.sleep(500);
    ...
    // 31. Click 'Ödeme Talimatı Oluştur Button'
    GeneratedUtils.sleep(500);
    by = By.xpath("//input[@type='button' and @value='ÖDEME TALİMATI OLUŞTUR']");
    driver.findElement(by).click();

    // 32. Is 'payment-instruction-form' visible?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#payment-instruction-form");
    driver.findElement(by).isDisplayed();

    // 33. Set 'style' attribute value on 'slimScrollDiv'
    GeneratedUtils.sleep(500);
    ...
    // 34. Set 'style' attribute value on 'slimScrollDiv>div'
    GeneratedUtils.sleep(500);
    ...
    // 41. Does 'Bireysel Ana Bayi (Silmeyiniz-Değişti...5' contain 'Bireysel Ana Bayi (Silmeyiniz-Değiştirmeyiniz)'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//strong[2][. = 'Bireysel Ana Bayi (Silmeyiniz-Değiştirmeyiniz)']");
