 ...
 * Test: C713 Site Kullanıcısı silme (en az bir admin olmak zorunda)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 10:59:50 GMT 2022.
 */
@DisplayName("C713 Site Kullanıcısı silme (en az bir admin olmak zorunda)")
public class C713 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 12. Does 'TabloCell' contain 'Gösterilecek Kayıt Bulunamadı.'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td");
