 ...
 * Test: C951 Çek/Senet/Nakit işlem detayında bakiye bilgisinin kontrol edilmesi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 07:55:15 GMT 2022.
 */
@DisplayName("C951 Çek/Senet/Nakit işlem detayında bakiye bilgisinin kontrol edilmesi")
public class C951 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String FullReferansCekSenet,
    ...
    // 15. Move mouse to 'ExpiryDateEnd'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ExpiryDateEnd");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 16. Clear 'ExpiryDateEnd' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ExpiryDateEnd");
    driver.findElement(by).clear();

    // 17. Type '{{ReferansResult}}' in 'OrderReference'
    GeneratedUtils.sleep(500);
    ...
    //    Tutar - 11,00 - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Tutar","11,00","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 21. Click 'imgIslemDetaylariCekSenet'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[href^=\"/Admin/ChequeVoucher\"] img[src*='fugue/salesdetail.png']");
    driver.findElement(by).click();

    // 22. Does 'TutarIslemDetaylariCekSenet' contain '11,00'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[normalize-space()='Tutar']//following-sibling::td  ");
    Assertions.assertTrue(driver.findElement(by).getText().contains("11,00"));

    // 23. Does 'ReferansIslemCekSenet' contain '{{ReferansResult}}'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[normalize-space()='Referans No']//following-sibling::td  ");
    Assertions.assertTrue(driver.findElement(by).getText().contains(ReferansResult));
