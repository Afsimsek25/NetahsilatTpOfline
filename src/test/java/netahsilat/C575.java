 ...
 * Test: C575 Date Time Kontrolü
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 09:14:42 GMT 2022.
 */
@DisplayName("C575 Date Time Kontrolü")
public class C575 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String today) throws
    ...
    // 5. Move mouse to 'Open the calendar5'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[2]//span[. = 'Open the calendar']");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 6. Click 'Open the calendar5'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[2]//span[. = 'Open the calendar']");
    driver.findElement(by).click();
    ...
    // 18. Click 'Open the time view4'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[2]//span[. = 'Open the time view']");
    driver.findElement(by).click();
