 ...
 * Test: C523 Onay Durumu İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:39:50 GMT 2022.
 */
@DisplayName("C523 Onay Durumu İle Listeleme")
public class C523 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Onay Durumu","Beklemede","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'StatusId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Onay Durumu","Onay","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 17. Select options in 'StatusId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 21. Select options in 'StatusId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Onay Durumu","Red","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
