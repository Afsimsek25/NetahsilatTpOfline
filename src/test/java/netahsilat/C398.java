 ...
 * Test: C398 İşlem Durumu İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Sep 28 20:41:24 GMT 2022.
 */
@DisplayName("C398 İşlem Durumu İle Listeleme")
public class C398 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 8. Deselect all options in 'SelectedTransactionStateId'
    GeneratedUtils.sleep(500);
    ...
    // 9. Select options in 'SelectedTransactionStateId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 12. Is 'basariliOnGrid' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[text()='Başarılı']");
    driver.findElement(by).isDisplayed();

    // 13. Deselect all options in 'SelectedTransactionStateId'
    GeneratedUtils.sleep(500);
    deselectAllOptions = WebExtensions.getDeselectAllOptions();
    by = By.cssSelector("#SelectedTransactionStateId");
    deselectAllOptions = (WebExtensions.DeselectAllOptions)((ReportingDriver)driver).addons().execute(deselectAllOptions, by, -1);

    // 14. Select options in 'SelectedTransactionStateId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Başarısız İşlemler");
    by = By.cssSelector("#SelectedTransactionStateId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    // 17. Is 'basarisizOnGrid' visible?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[text()='Başarısız']");
    driver.findElement(by).isDisplayed();
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);

    // 18. Deselect all options in 'SelectedTransactionStateId'
    GeneratedUtils.sleep(500);
    deselectAllOptions = WebExtensions.getDeselectAllOptions();
    by = By.cssSelector("#SelectedTransactionStateId");
    deselectAllOptions = (WebExtensions.DeselectAllOptions)((ReportingDriver)driver).addons().execute(deselectAllOptions, by, -1);

    // 19. Select options in 'SelectedTransactionStateId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Bekleyen İşlemler");
    by = By.cssSelector("#SelectedTransactionStateId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    // 22. Is 'bekleyenOnGrid' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[text()='Bekleyen']");
    driver.findElement(by).isDisplayed();
