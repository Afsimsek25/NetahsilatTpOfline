 ...
 * Test: C636 Ek Bilgiler Sekmesi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 07:17:11 GMT 2022.
 */
@DisplayName("C636 Ek Bilgiler Sekmesi")
public class C636 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String randomERP,
      String odemeLinki) throws Exception {
    ...
    // 13. Move mouse to 'TV2'
    GeneratedUtils.sleep(500);
    by = By.xpath("//option[1][. = 'TV']");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();
    ...
    // 19. Get 'href' attribute value on 'Ödeme'
    GeneratedUtils.sleep(500);
    ...
    // 20. Navigate to '{{odemeLinki}}'
    GeneratedUtils.sleep(500);
    driver.navigate().to(odemeLinki);

    // 21. Is 'TV' visible and selected?
    GeneratedUtils.sleep(500);
    by = By.xpath("//option[. = 'TV']");
    (new WebDriverWait(driver, 15)).until(ExpectedConditions.elementSelectionStateToBe(by, true));

    // 22. Does 'fatura_15' contain '12345678'?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#fatura_15");
    Assertions.assertTrue(driver.findElement(by).getText().contains("12345678"));

    // 23. Does 'aciklama_10' contain 'otomasyonaciklama'?
    GeneratedUtils.sleep(500);
