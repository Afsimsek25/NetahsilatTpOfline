 ...
 * Test: C717 Site kullanıcı rol grup değişikliği
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 10:59:28 GMT 2022.
 */
@DisplayName("C717 Site kullanıcı rol grup değişikliği")
public class C717 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Click 'inputEmailPricinPage'
    by = By.cssSelector("#Email");
    driver.findElement(by).click();

    // 6. Type 'sitekullanicisi@qualitymuseum.com' in 'inputEmailPricinPage'
    by = By.cssSelector("#Email");
    ...
    // 8. Is 'sitekullanicisi@qualitymuseum.com' visible?
    by = By.xpath("//tr[1]//td[. = 'sitekullanicisi@qualitymuseum.com']");
    driver.findElement(by).isDisplayed();

    // 9. Click 'Rol/Ekle Çıkar'
    ...
    // 14. Does 'RoleGroupId1' contain 'Site Admin'?
    by = By.xpath("//div/div/div[1]/div[1]//select");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Site Admin"));

    // 15. Select options in 'RoleGroupId' with text '[NONE]'
    ...
    // 18. Click 'Rol/Ekle Çıkar'
    by = By.cssSelector("img[src*='question.png']");
    driver.findElement(by).click();

    // 19. Does 'RoleGroupId1' contain 'Site Muhasebe'?
    by = By.xpath("//div/div/div[1]/div[1]//select");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Site Muhasebe"));
    ...
    // 22. This test was auto generated from steps of the 'C1909-Listelerde ki verilerin maskelenmesi' test
    methodrefreshloadingcontrol = new MethodRefreshLoadingControl();
    methodrefreshloadingcontrol.execute(driver);
