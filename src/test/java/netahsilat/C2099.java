 ...
 * Test: C2099 Ödeme Talimat Formu - Site Sahibi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 11:13:46 GMT 2022.
 */
@DisplayName("C2099 Ödeme Talimat Formu - Site Sahibi")
public class C2099 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String kartNo, String CVV,
    ...
    // 7. Click 'Site sahibi (Unchecked) -Ödeme Talimat Formu' if it's visible
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
    ...
    // 12. Is 'Ödeme Talimatı Oluştur Button' not present or invisible?
    // set step-specific timeout (will undo this at the end)
    ...
    // 13. Is 'payment-instruction-form' not present or invisible?
    ...
    // 14. Is 'btnNormalPayment' visible?
    ...
    // 20. Click 'Site sahibi (Checked) - Ödeme Talimat Formu'
    ...
    // 36. Does 'Talimat Formu - Provizyon Tutarı XPath' contain ': 100 ₺ .'?
    ...
    // 39. Does 'Otomasyon A.Ş3' contain 'Otomasyon A.Ş'?
    by = By.xpath("//strong[2][. = 'Otomasyon A.Ş']");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Otomasyon A.Ş"));
