 ...
 * Test: C526   Şehir İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:58:01 GMT 2022.
 */
@DisplayName("C526   Şehir İle Listeleme")
public class C526 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Select options in 'CityId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Adana");
    ...
    //    Şehir - Adana - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Şehir","Adana","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'CityId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    //    Şehir - İstanbul - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Şehir","İstanbul","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
