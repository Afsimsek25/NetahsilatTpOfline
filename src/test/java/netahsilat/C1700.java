 ...
 * Test: C1700 Altbayi posu tanımlı bir bayi adına üyeliksiz email order gönderme (Ödeme alt bayi posundan geçmelidir.)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:19:16 GMT 2022.
 */
@DisplayName("C1700 Altbayi posu tanımlı bir bayi adına üyeliksiz email order gönderme (Ödeme alt bayi posundan geçmelidir.)")
public class C1700 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String RandomTutar1,
    ...
    // 7. Type 'altbayipos@yandex.com' in 'SearchVendorName'
    ...
    // 11. Click 'Üye adına üyeliksiz ödeme linki gönde...'
    ...
    // 14. Run Clear 'PureAmount' contents and type '{{RandomTutar1}},{{RandomTutar2}}'
    ...
    // 18. Type 'C1700' in 'DisplayName'
    by = By.cssSelector("#DisplayName");
    driver.findElement(by).sendKeys("C1700");

    // 19. Type 'netahsilatotomasyon@yandex.com' in 'send-otp-via-mfs-input'
    by = By.xpath("//div[2]/div[2]/input");
    driver.findElement(by).sendKeys("netahsilatotomasyon@yandex.com");

    // 20. Type 'C1700' in 'Description'
    ...
    // 22. Click 'Responsive Gonder Button'
    ...
    // 24. Output searched string in specific mail
    readSpecificsMail = ImapMailOperations.readSpecificsMail(ProjectParameters.odemeEmail,ProjectParameters.yandexMailKey,Tutar,"C:/TestProject/mail/C1700.html");
    readSpecificsMail = (ImapMailOperations.ReadSpecificsMail)((ReportingDriver)driver).addons().execute(readSpecificsMail);

    // 25. Navigate to 'file:///C:/TestProject/mail/C1700.html'
    driver.navigate().to("file:///C:/TestProject/mail/C1700.html");

    // 26. Click 'Ödeme yapmak için lütfen tıklayınız'
    by = By.cssSelector("#odemelinki");
    driver.findElement(by).click();

    // 27. Is 'Kart Üzerindeki İsim' visible?
    by = By.cssSelector("#CardHolderName");
    driver.findElement(by).isDisplayed();

    // 28. Run Method Parametrik Ödeme (Sadece Kart - Type text with delay)  - İsimsiz
    ...
    // 29. Move mouse to 'Vakıfbank Tek Çekim Posu'
    by = By.cssSelector("td[class*='commRate-4050'] input");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 30. Click 'Vakıfbank Tek Çekim Posu'
    by = By.cssSelector("td[class*='commRate-4050'] input");
    driver.findElement(by).click();
    ...
    // 34. Get substring of '{{ReferansNumber}}' from '42' to '[NONE]'
    ...
    // 35. Run Method Vakıfbank İşlem Durumu Sorgulama
