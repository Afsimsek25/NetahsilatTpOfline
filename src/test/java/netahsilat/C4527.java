 ...
 * Test: C4527 Rol Grubu Ekleme/Güncelleme/Sil (Alt Bayi)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:13:15 GMT 2022.
 */
@DisplayName("C4527 Rol Grubu Ekleme/Güncelleme/Sil (Alt Bayi)")
public class C4527 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String currentDateTime)
    ...
    // 8. Type 'OtomasyonAltBayiAdmin' in 'Rol Grubu Adı'
    by = By.xpath("//input[@id='RoleGroupName']");
    driver.findElement(by).sendKeys("OtomasyonAltBayiAdmin");

    // 9. Does 'Yetki Tipi' contain 'AltBayi'?
    by = By.cssSelector("#RoleGroupType");
    Assertions.assertTrue(driver.findElement(by).getText().contains("AltBayi"));
    ...
    conditionalClick = GridOperations.conditionalClick("//td[text()='OtomasyonAltBayiAdmin']/..//img[contains(@src,'edit.png')]",false);
    ...
    // 16. Click 'OtomasyonAltBayiAdmin Düzenle'
    by = By.xpath("//td[text()='OtomasyonAltBayiAdmin']/..//img[contains(@src,'edit.png')]");
    driver.findElement(by).click();

    // 17. Run Clear 'rol Grubu Adı OtomasyonAltBayiAdmin' contents and type 'OtomasyonAltBayiAdminGüncelle'
    clearAndTypeAction = CombinedActions.clearAndTypeAction("OtomasyonAltBayiAdminGüncelle");
    by = By.xpath("//input[@id='RoleGroupName'][@value='OtomasyonAltBayiAdmin']");
    ...
    // 20. Click 'Firma Bilgileri Güncelleme Checkbox'
    by = By.xpath("//span[text()='Firma Bilgileri Güncelleme']//..//input[2]");
    driver.findElement(by).click();

    // 21. Is 'Firma Bilgileri Güncelleme Checkbox' visible and selected?
    //    INVERT STEP RESULT
    ...
    try {
      by = By.xpath("//span[text()='Firma Bilgileri Güncelleme']//..//input[2]");
      (new WebDriverWait(driver, 2)).until(ExpectedConditions.elementSelectionStateToBe(by, true));
      Assertions.fail("Step 'Is 'Firma Bilgileri Güncelleme Checkbox' visible and selected?' result inverted, step failed");
    }
    catch (RuntimeException ex) {
    }
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);

    // 22. Click 'İşlemler Checkbox'
    by = By.xpath("//span[text()='İşlemler']//..//input[2]");
    driver.findElement(by).click();

    // 23. Is 'İşlemler Checkbox' visible and selected?
    //    INVERT STEP RESULT
    ...
    // 28. Click 'OtomasyonAltBayiAdminGüncelle Düzenle'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);
    by = By.xpath("//td[text()='OtomasyonAltBayiAdminGüncelle']/..//img[contains(@src,'edit.png')]");
    driver.findElement(by).click();
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);

    // 29. Does 'Yetki Tipi' contain 'AltBayi'?
    ...
    // 32. Is 'Firma Bilgileri Güncelleme Checkbox' visible and selected?
    //    INVERT STEP RESULT
    ...
    // 33. Is 'İşlemler Checkbox' visible and selected?
    //    INVERT STEP RESULT
    ...
    // 37. Click 'OtomasyonAltBayiAdminGüncelle delete'
    by = By.xpath("//td[text()='OtomasyonAltBayiAdminGüncelle']/..//img[contains(@src,'trash.png')]");
    driver.findElement(by).click();
    ...
    // 39. Is 'OtomasyonAltBayiAdminGüncelle' not present or invisible?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(7000, TimeUnit.MILLISECONDS);
    by = By.xpath("//td[text()='OtomasyonAltBayiAdminGüncelle']");
