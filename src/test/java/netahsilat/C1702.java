 ...
 * Test: C1702 Bayi yerine ödeme yapma
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:21:22 GMT 2022.
 */
@DisplayName("C1702 Bayi yerine ödeme yapma")
public class C1702 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String RandomTutar1,
    ...
    // 21. Is 'Payment Efekti' visible?
    by = By.cssSelector("div[class='spinner']");
    driver.findElement(by).isDisplayed();

    // 22. Get text from 'txtReferansNumarasi'
    ...
    // 23. Get substring of '{{ReferansNumber}}' from '42' to '[NONE]'
    ...
    // 24. Run Method Vakıfbank İşlem Durumu Sorgulama
