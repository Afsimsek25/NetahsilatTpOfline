 ...
 * Test: C518 Banka Hesap No İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:43:55 GMT 2022.
 */
@DisplayName("C518 Banka Hesap No İle Listeleme")
public class C518 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Is 'AccountNumber' present?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AccountNumber");
    driver.findElement(by);

    // 10. Type '123456' in 'AccountNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#AccountNumber");
    ...
    //    Banka Hesap No - 123456 - startsWith
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Banka Hesap No","123456","startsWith");
