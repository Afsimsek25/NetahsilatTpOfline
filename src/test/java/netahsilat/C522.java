 ...
 * Test: C522 Belge Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:37:23 GMT 2022.
 */
@DisplayName("C522 Belge Tipi İle Listeleme")
public class C522 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Select options in 'DocumentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("2. Kişi Gerekli Değil");
    by = By.cssSelector("#DocumentTypeId");
    ...
    //    Belge Tipi - Kefilsiz - Contains
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Belge Tipi","Kendi Çeki","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'DocumentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("2. Kişi Gerekli");
    by = By.cssSelector("#DocumentTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    //    Belge Tipi - Kefil Gerekli - Contains
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Belge Tipi","Cirolu Çek","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
