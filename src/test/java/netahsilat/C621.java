 ...
 * Test: C621 Şehir İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 06:40:37 GMT 2022.
 */
@DisplayName("C621 Şehir İle Listeleme")
public class C621 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Select options in 'SearchCity' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 9. Is 'sartlibayi' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr[1]//td[. = 'sartlibayi']");
    driver.findElement(by).isDisplayed();
    ...
    // 11. Does 'Entity.AddressModel.CityId' contain 'Karabük'?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#Entity_AddressModel_CityId");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Karabük"));
