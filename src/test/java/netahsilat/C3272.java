 ...
 * Generated on Sun Oct 09 20:48:52 GMT 2022.
 */
@DisplayName("C3272")
public class C3272 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String CurrentDate) throws
    ...
    // 22. Get current date
    GeneratedUtils.sleep(500);
    currentDate = DateTimeOperations.currentDate("d.MM.yyyy HH");
    ...
    // 28. Does 'İşlem 1. Alıcı' contain ':Bi'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//strong[normalize-space()='1. Alıcı']/..//..//td[2]");
    Assertions.assertTrue(driver.findElement(by).getText().contains(":Bi"));
