 ...
 * Test: C1969 Excel ile site kullanıcı aktarımı - Aynı Email Validasyonu
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 11 07:19:19 GMT 2022.
 */
@DisplayName("C1969 Excel ile site kullanıcı aktarımı - Aynı Email Validasyonu")
public class C1969 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    GeneratedUtils.sleep(500);
    uploadFileElementAction = FileUpload.uploadFileElementAction("C:\\TestProject\\C1969.xlsx");
    ...
    // 10. Does 'Email alanı tekil olmalıdır. Satır : ...' contain 'Email alanı tekil olmalıdır. Satır : 1 Stun : 3'?
    GeneratedUtils.sleep(500);
    by = By.xpath("//p[. = 'Email alanı tekil olmalıdır. Satır : 1 Stun : 3']");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Email alanı tekil olmalıdır. Satır : 1 Stun : 3"));
