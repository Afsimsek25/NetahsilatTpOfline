 ...
 * Test: C513 Banka Adı (Bayi/Müşteri) İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 20:43:29 GMT 2022.
 */
@DisplayName("C513 Banka Adı (Bayi/Müşteri) İle Listeleme")
public class C513 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 10. Select options in 'VendorVPosId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Garanti Bankası");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Banka","Garanti Bankası","Equals");
