 ...
 * Test: C1892 Aylık Ödeme - İptal Tutarları Raporunda Çoklu Müşteri Temsilci Seçimi (NTH-14687)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 08:35:58 GMT 2022.
 */
@DisplayName("C1892 Aylık Ödeme - İptal Tutarları Raporunda Çoklu Müşteri Temsilci Seçimi (NTH-14687)")
public class C1892 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String ElementCount)
    ...
    // 6. Click 'Aylık Ödeme - İptal Tutarları'
    by = By.xpath("//a[contains(text(),'Aylık Ödeme - İptal Tutarları')]/../a");
    driver.findElement(by).click();

    // 7. Is 'Aylık Ödeme - İptal Tutarları h1' visible?
    by = By.xpath("//h1[. = 'Aylık Ödeme - İptal Tutarları']");
