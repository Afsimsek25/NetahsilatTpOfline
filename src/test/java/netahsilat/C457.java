 ...
 * Test: C457 İşlem Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 20:58:09 GMT 2022.
 */
@DisplayName("C457 İşlem Tipi İle Listeleme")
public class C457 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Type '31.08.2021 23:59' in 'EndDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#EndDate");
    driver.findElement(by).sendKeys("31.08.2021 23:59");
    ...
    // 14. Select options in 'VPosTransactionTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("İşlem Tipi","Satış","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 18. Select options in 'VPosTransactionTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("İşlem Tipi","Provizyon","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
