 ...
 * Test: C443 İşlem Tarihi Kontrolü
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 15:57:47 GMT 2022.
 */
@DisplayName("C443 İşlem Tarihi Kontrolü")
public class C443 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String today) throws
    ...
    // 7. Click 'Open the calendar3'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[2]/fieldset/div[2]//span[. = 'Open the calendar']");
    driver.findElement(by).click();
    ...
    // 12. Get value of 'color' CSS property on 'StartDate'
    GeneratedUtils.sleep(500);
    ...
    // 14. Type '12.12.2020' in 'StartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#StartDate");
    ...
    // 16. Get text from 'StartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#StartDate");
    string = driver.findElement(by).getAttribute("value");
    Assertions.assertTrue(string.startsWith("12.12.2020 00:00"));

    // 17. Click 'Open the time view1'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[2]/fieldset/div[2]//span[. = 'Open the time view']");
    driver.findElement(by).click();

    // 18. List Elements Contains Text
    GeneratedUtils.sleep(500);
