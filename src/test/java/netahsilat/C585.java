 ...
 * Test: C585 Müşteri Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 08:31:22 GMT 2022.
 */
@DisplayName("C585 Müşteri Tipi İle Listeleme")
public class C585 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String gridHeaders,
    ...
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Ana Bayi");
    ...
    // 9. Type 'Bireysel Alt Bayi' in 'VendorName'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#VendorName");
    driver.findElement(by).sendKeys("Bireysel Alt Bayi");

    // 10. Click 'Bireysel Alt Bayi (Silmeyiniz-Değişti...'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ui-id-22");
    driver.findElement(by).click();
    ...
    //    Bayi Kodu - BireyselAltBayi - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Bayi Kodu","BireyselAltBayi","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 14. Select options in 'VendorTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 17. Does 'Gösterilecek Kayıt Bulunamadı.' contain 'Gösterilecek Kayıt Bulunamadı.'?
    GeneratedUtils.sleep(500);
