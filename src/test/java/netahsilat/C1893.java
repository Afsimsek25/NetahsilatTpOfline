 ...
 * Test: C1893 Bayi Ödeme Adetleri Raporunda Çoklu Müşteri Temsilci Seçimi (NTH-14688)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 11 07:22:13 GMT 2022.
 */
@DisplayName("C1893 Bayi Ödeme Adetleri Raporunda Çoklu Müşteri Temsilci Seçimi (NTH-14688)")
public class C1893 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String ElementCount,
      String MusteriTemsilcisiColum, String UserProfile, String element, String ReplaceData,
      String Temsilci1, String Temsilci2, String Temsilci3, String Temsilci4, String TabloBaslik)
      throws Exception {
    ...
    // 6. Click 'Bayi ödeme adetleri'
    by = By.xpath("//a[contains(text(),'Bayi ödeme adetleri')]/../a");
    driver.findElement(by).click();

    // 7. Is 'Bayi Ödeme Adetleri h1' visible?
    by = By.xpath("//h1[. = 'Bayi Ödeme Adetleri']");
    ...
    // 18. This test was auto generated from steps of the 'C1898 Geri Ödeme Detayları Sayfasında Çoklu Müşteri Temsilci Seçimi (NTH-14692)' test
    ...
    String path = UserProfile + "/Downloads/Bayi Ödeme Adetleri.xls";


    // 20. Delete the file from '{{UserProfile}}\Downloads\Bayi Ödeme Adetleri.xlsx'
    ...
    // 21. Click 'Excel'e Aktar1'
    by = By.cssSelector("#exportReport");
    driver.findElement(by).click();

    // 22. Wait Until The File is Downloaded
    ...
    // 23. Search multiple matching in Exel Column
    multipleMatching = CommunityExcelActionsforWindows.multipleMatching(path,1,7,"Site Müşteri Temsilcisi 1,Site Müşteri Temsilcisi 2");
    multipleMatching = (CommunityExcelActionsforWindows.multipleMatching)((ReportingDriver)driver).addons().execute(multipleMatching);
    currentDateTime = String.valueOf(multipleMatching.columnValue);
  ...
  private static Stream provideParameters() throws Exception {
    return Stream.of(Arguments.of("https://otomasyon2.netahsilatdemo.com/","Kd!cyhz4","","","","","","","","","!!","!!","Müşteri Temsilcisi Adı"));
  }
}
