 ...
 * Test: C414 Ödeme Kaynağı İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Sep 29 17:10:56 GMT 2022.
 */
@DisplayName("C414 Ödeme Kaynağı İle Listeleme")
public class C414 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 7. Select options in 'PaymentFunctionTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Normal Ödeme");
    by = By.cssSelector("#PaymentFunctionTypeId");
    ...
    //    Ödeme Yöntemi - Normal Ödeme - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Yöntemi","Normal Ödeme","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 11. Select options in 'PaymentFunctionTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Mail-SMS Order Ödeme");
    by = By.cssSelector("#PaymentFunctionTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    //    Ödeme Yöntemi - Mail-SMS Order Ödeme - Equals
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Yöntemi","Mail-SMS Order Ödeme","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
