 ...
 * Test: C436  Banka Adı (Bayi/Müşteri) İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 11:08:21 GMT 2022.
 */
@DisplayName("C436  Banka Adı (Bayi/Müşteri) İle Listeleme")
public class C436 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 7. Select options in 'VendorVPosId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    //    Banka Sütunu altında Akbank1 in Equals olması gerekmektedir
    GeneratedUtils.sleep(500);
