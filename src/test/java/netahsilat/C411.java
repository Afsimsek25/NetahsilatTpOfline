 ...
 * Test: C411 Ödeme Kalemi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Sep 29 16:48:47 GMT 2022.
 */
@DisplayName("C411 Ödeme Kalemi İle Listeleme")
public class C411 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Deselect all options in 'SelectedPaymentItemId'
    GeneratedUtils.sleep(500);
    ...
    // 6. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Referans","NT56154P0000018387","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 12. Run Get Data From Grid
    /* Step is disabled
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Entegrasyon Id / Ödeme Kalemi","TestOtomasyon","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
    */
    // 13. Click 'islemDetaylariOnGrid'
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr/td/a[1]/img");
    driver.findElement(by).click();

    // 14. Is 'TestOtomasyon' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//*[normalize-space()='TestOtomasyon']");
    driver.findElement(by).isDisplayed();
    ...
    // 16. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 19. Click 'islemDetaylariOnGrid'
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr/td/a[1]/img");
    driver.findElement(by).click();

    // 20. Is 'Ürün 11' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//*[normalize-space()='Ürün 1']");
    driver.findElement(by).isDisplayed();
