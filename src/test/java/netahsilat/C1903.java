 ...
 * Test: C1903 Çoklu Müşteri Temsilcisi ile Müşteri Aktarımı (NTH-14697)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 08:35:51 GMT 2022.
 */
@DisplayName("C1903 Çoklu Müşteri Temsilcisi ile Müşteri Aktarımı (NTH-14697)")
public class C1903 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String ss) throws
      Exception {
    ...
    GeneratedUtils.sleep(500);
    uploadFileElementAction = FileUpload.uploadFileElementAction("C:\\TestProject\\C1903_Müşteri_Aktarim.xlsx");
    ...
    // 13. Type 'C1903Code' in 'SearchVendorNameVN'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).sendKeys("C1903Code");
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);
    ...
    // 17. Is 'Grid 1.Satır C1903Code' visible?
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr[1]/td[. = 'C1903Code']");
    driver.findElement(by).isDisplayed();
