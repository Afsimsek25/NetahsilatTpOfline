 ...
 * Test: C864 Müşterinin ERP kodunu değiştirdiğimizde Cari hesap kodu değişmeyecek (bayi gibi çalışıyor)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 13:11:41 GMT 2022.
 */
@DisplayName("C864 Müşterinin ERP kodunu değiştirdiğimizde Cari hesap kodu değişmeyecek (bayi gibi çalışıyor)")
public class C864 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 13. Get text from 'Entity.ErpCode'
    by = By.cssSelector("#Entity_ErpCode");
    string = driver.findElement(by).getAttribute("value");
    Assertions.assertEquals("123456789", string);

    // 14. Click 'btnCariHesaplar'
    by = By.cssSelector("img[src*='Paper-Money-icon.png']");
    driver.findElement(by).click();

    // 15. Does 'Entity.CurrentAccounts[0].ErpCode' contain '12345'?
    ...
    // 18. Clear 'Entity.ErpCode' contents
    by = By.cssSelector("#Entity_ErpCode");
    driver.findElement(by).clear();

    // 19. Type '12345' in 'Entity.ErpCode'
    by = By.cssSelector("#Entity_ErpCode");
