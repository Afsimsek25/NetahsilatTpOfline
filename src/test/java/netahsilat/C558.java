 ...
 * Test: C558 Excel'e Aktar
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 10:54:43 GMT 2022.
 */
@DisplayName("C558 Excel'e Aktar")
public class C558 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String gridHeaders,
    ...
    //    C:\Users\testortak\Downloads\email-order.xls
    GeneratedUtils.sleep(500);
    deleteFile = CommunityExcelActionsforWindows.deleteFile("%USERPROFILE%\\Downloads\\email-order.xls");
    ...
    GeneratedUtils.sleep(500);
    waitUntilFileDownloaded = CommunityExcelActionsforWindows.waitUntilFileDownloaded("%USERPROFILE%\\Downloads\\email-order.xls",30);
    ...
    // 8. Read Excel Row
    GeneratedUtils.sleep(500);
    readRowValue = CommunityExcelActionsforWindows.readRowValue("%USERPROFILE%\\Downloads\\email-order.xls",1,1);
