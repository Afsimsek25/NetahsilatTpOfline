 ...
 * Test: C5351 Tali Bayi Posu Aktif - Altbayi login olup ödeme yapma
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:21:48 GMT 2022.
 */
@DisplayName("C5351 Tali Bayi Posu Aktif - Altbayi login olup ödeme yapma")
public class C5351 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String RandomTutar1,
    ...
    methodlogin.userName = "talibayipos@yandex.com";
    ...
    // 16. Navigate to '{{Otomasyon2Logout}}'
    driver.navigate().to(ProjectParameters.Otomasyon2Logout);
    ...
    // 18. Move mouse to 'moveToSiteYönetimi'
    by = By.cssSelector("li[class='config']");
    (new Actions(driver)).moveToElement(driver.findElement(by)).perform();

    // 19. Click 'SİTE YÖNETİMİ1'
    by = By.xpath("//a[. = 'SİTE YÖNETİMİ']");
    driver.findElement(by).click();

    // 20. Click 'PARAMETRELER'
    by = By.xpath("//a[. = 'PARAMETRELER']");
    driver.findElement(by).click();

    // 21. Is 'Tali Bayi Posu Aktif mi? (Checked)' visible?
    GeneratedUtils.sleep(1000);
    by = By.xpath("//label[normalize-space()='Tali Bayi Posu Aktif mi?']//..//following-sibling::div//span[@class='jquery-safari-checkbox jquery-safari-checkbox-checked']");
    driver.findElement(by).isDisplayed();

    // 22. Click 'Tali Bayi Posu Aktif mi? (Checked)'
    by = By.xpath("//label[normalize-space()='Tali Bayi Posu Aktif mi?']//..//following-sibling::div//span[@class='jquery-safari-checkbox jquery-safari-checkbox-checked']");
    driver.findElement(by).click();
    ...
    // 24. Is 'Genel parametreler Başarıyla kaydedil...' visible?
