 ...
 * Test: C589 Ödeme Şekli İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 08:08:12 GMT 2022.
 */
@DisplayName("C589 Ödeme Şekli İle Listeleme")
public class C589 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Select options in 'SelectedInstalmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Taksit","1","startsWith");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'SelectedInstalmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Taksitli");
    by = By.cssSelector("#SelectedInstalmentTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    try {
      GeneratedUtils.sleep(500);
      getData = GridOperations.getData("Taksit","1","Equals");
      getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
      Assertions.fail("Step 'Run Get Data From Grid' result inverted, step failed");
    }
