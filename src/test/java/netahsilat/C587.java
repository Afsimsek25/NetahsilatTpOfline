 ...
 * Test: C587 Ödeme Kalemi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 08:01:54 GMT 2022.
 */
@DisplayName("C587 Ödeme Kalemi İle Listeleme")
public class C587 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 8. Deselect all options in 'SelectedPaymentItemId'
    GeneratedUtils.sleep(500);
    deselectAllOptions = WebExtensions.getDeselectAllOptions();
    by = By.cssSelector("#SelectedPaymentItemId");
    deselectAllOptions = (WebExtensions.DeselectAllOptions)((ReportingDriver)driver).addons().execute(deselectAllOptions, by, -1);

    // 9. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("TestOtomasyon");
    by = By.cssSelector("#SelectedPaymentItemId");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Kalemi","TestOtomasyon","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Deselect all options in 'SelectedPaymentItemId'
    GeneratedUtils.sleep(500);
    deselectAllOptions = WebExtensions.getDeselectAllOptions();
    by = By.cssSelector("#SelectedPaymentItemId");
    deselectAllOptions = (WebExtensions.DeselectAllOptions)((ReportingDriver)driver).addons().execute(deselectAllOptions, by, -1);

    // 14. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Ürün 1");
    by = By.cssSelector("#SelectedPaymentItemId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Kalemi","Ürün 1","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 18. Deselect all options in 'SelectedPaymentItemId'
    GeneratedUtils.sleep(500);
    deselectAllOptions = WebExtensions.getDeselectAllOptions();
    by = By.cssSelector("#SelectedPaymentItemId");
    deselectAllOptions = (WebExtensions.DeselectAllOptions)((ReportingDriver)driver).addons().execute(deselectAllOptions, by, -1);

    // 19. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Sabit Tutar");
    by = By.cssSelector("#SelectedPaymentItemId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Kalemi","Sabit Tutar","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
