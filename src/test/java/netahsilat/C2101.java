 ...
 * Test: C2101 Ödeme Talimat Formu - Müşteri
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 11:14:21 GMT 2022.
 */
@DisplayName("C2101 Ödeme Talimat Formu - Müşteri")
public class C2101 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String kartNo, String CVV,
    ...
    // 7. Click 'Müşteri (Unchecked) - Ödeme Talimat Formu' if it's visible
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
    ...
    // 21. Click 'Müşteri (Checked) - Ödeme Talimat Formu'
    ...
    // 26. Clear the contents of 'PureAmount' if it's visible
    ...
    // 39. Does 'Bireysel türk3' contain 'Bireysel türk'?
    by = By.xpath("//strong[2][. = 'Bireysel türk']");
