 ...
 * Test: C428 Müşteri Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 15:11:33 GMT 2022.
 */
@DisplayName("C428 Müşteri Tipi İle Listeleme")
public class C428 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 6. Select options in 'VendorTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    //    İşlem Tipi Sütununda Satış Contains
    GeneratedUtils.sleep(500);
    ...
    // 12. Type 'NT56154P0000018386' in 'ReferenceNumber'
    GeneratedUtils.sleep(500);
    ...
    // 16. Select options in 'VendorTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 18. Type 'NT56154P0000018384' in 'ReferenceNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ReferenceNumber");
    ...
    // 22. Select options in 'VendorTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Üyeliksiz");
    by = By.cssSelector("#VendorTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);

    // 23. Clear 'ReferenceNumber' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ReferenceNumber");
    driver.findElement(by).clear();

    // 24. Type 'NT56154P0000018387' in 'ReferenceNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ReferenceNumber");
