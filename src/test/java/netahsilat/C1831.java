 ...
 * Test: C1831 Grid Kontrolleri
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 06:59:51 GMT 2022.
 */
@DisplayName("C1831 Grid Kontrolleri")
public class C1831 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String gridHeaders) throws
    ...
    // 5. Is 'Contains a[Bayi/Kullanıcı Adı]' visible?
    by = By.xpath("//a[contains(text(),'Bayi/Kullanıcı Adı')]");
    ...
    // 7. Type '{{gridHeaders}}' in 'fatura_text'
    /* Step is disabled
    by = By.cssSelector("#fatura_text");
    driver.findElement(by).sendKeys(gridHeaders);
    */
  }
