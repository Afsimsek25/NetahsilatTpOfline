 ...
 * Test: C638 Kapalı Saatler Sekmesi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 07:45:03 GMT 2022.
 */
@DisplayName("C638 Kapalı Saatler Sekmesi")
public class C638 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String randomERP) throws
    ...
    // 13. Click 'KapalıSaatlerTab'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[href*=\"#tab-kapalisaatler\"]");
    driver.findElement(by).click();

    // 14. Click 'Tüm Gün Kapalı (Değiştirmeyiniz) CheckBox (Unchecked)'
    GeneratedUtils.sleep(500);
    by = By.xpath("//label[normalize-space()='Tüm Gün Kapalı (Değiştirmeyiniz)']//span[@class='jquery-safari-checkbox']");
    driver.findElement(by).click();
    ...
    // 17. Click 'KapalıSaatlerTab'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[href*=\"#tab-kapalisaatler\"]");
    driver.findElement(by).click();

    // 18. Click 'Tüm Gün Kapalı (Değiştirmeyiniz) (Checked)' if it's visible
    GeneratedUtils.sleep(500);
    clickIfVisibleWeb = VisibleElementsOperations.clickIfVisibleWeb("");
    by = By.xpath("//label[normalize-space()='Tüm Gün Kapalı (Değiştirmeyiniz)']//span[@class='jquery-safari-checkbox jquery-safari-checkbox-checked']");
