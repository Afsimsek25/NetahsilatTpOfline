 ...
 * Test: C580 Mail Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 09:16:44 GMT 2022.
 */
@DisplayName("C580 Mail Tipi İle Listeleme")
public class C580 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 6. Clear 'EndDate' contents
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#EndDate");
    driver.findElement(by).clear();

    // 7. Select options in 'MailTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Ödeme");
    by = By.cssSelector("#MailTypeId");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Mail Tipi","Ödeme","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 11. Select options in 'MailTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("İptal");
    by = By.cssSelector("#MailTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Mail Tipi","İptal","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
