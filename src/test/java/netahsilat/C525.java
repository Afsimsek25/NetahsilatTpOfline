 ...
 * Test: C525 Banka İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:50:17 GMT 2022.
 */
@DisplayName("C525 Banka İle Listeleme")
public class C525 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Select options in 'NetahBankId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Banka","AKBANK T.A.Ş.","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'NetahBankId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Banka","AKBANK T.A.Ş.","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
