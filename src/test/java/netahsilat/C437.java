 ...
 * Test: C437 Bayi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 11:15:17 GMT 2022.
 */
@DisplayName("C437 Bayi İle Listeleme")
public class C437 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 7. Type '12.02.2021 00:00' in 'StartDate'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#StartDate");
    driver.findElement(by).sendKeys("12.02.2021 00:00");

    // 8. Type 'anamusteri01' in 'VendorName'
    GeneratedUtils.sleep(500);
    ...
    // 12. Click 'Grid-Title Bayi/Kullanıcı Adı'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[href*='By=VendorName']");
    driver.findElement(by).click();
    ...
    GeneratedUtils.sleep(500);
    getData = GetDataFromGridWithSpecificLocator.getData("div[class='t-widget t-grid'][id='VPosTransactionGrid']","Bayi/Kullanıcı Adı(sorted ascending)","Bireysel Yabancı (Değiştirmeyi","Equals");
    getData = (GetDataFromGridWithSpecificLocator.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 15. Click 'Grid-Title Bayi/Kullanıcı Adı'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("a[href*='By=VendorName']");
    driver.findElement(by).click();
    ...
    // 17. Get Data From Grid With Specific Locator
    GeneratedUtils.sleep(500);
    getData = GetDataFromGridWithSpecificLocator.getData("div[class='t-widget t-grid'][id='VPosTransactionGrid']","Bayi/Kullanıcı Adı(sorted descending)","Bireysel Yabancı (Değiştirmeyi","Equals");
    getData = (GetDataFromGridWithSpecificLocator.GetData)((ReportingDriver)driver).addons().execute(getData);
