 ...
 * Test: C520 T.C / Vergi No İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:55:39 GMT 2022.
 */
@DisplayName("C520 T.C / Vergi No İle Listeleme")
public class C520 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Is 'TaxTcknNumber' visible?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#TaxTcknNumber");
    driver.findElement(by).isDisplayed();

    // 10. Type '11111111110' in 'TaxTcknNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#TaxTcknNumber");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("T.C. / Vergi No","11111111110","Contains");
