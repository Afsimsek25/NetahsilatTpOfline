 ...
 * Test: C433 Ödeme Kalemi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 15:19:47 GMT 2022.
 */
@DisplayName("C433 Ödeme Kalemi İle Listeleme")
public class C433 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 5. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 9. Click 'islemDetaylariOnGrid'
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr/td/a[1]/img");
    driver.findElement(by).click();

    // 10. Is 'TestOtomasyon' visible?
    GeneratedUtils.sleep(500);
    ...
    // 12. Select options in 'SelectedPaymentItemId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 15. Click 'islemDetaylariOnGrid'
    GeneratedUtils.sleep(500);
    by = By.xpath("//tr/td/a[1]/img");
    driver.findElement(by).click();

    // 16. Is 'Ürün 11' visible?
    GeneratedUtils.sleep(500);
