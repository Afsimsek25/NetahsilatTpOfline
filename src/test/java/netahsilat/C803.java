 ...
 * Test: C803 Excel bayi aktarımı yapılırken taxnumber 11 haneli olarak aktarım yapılabilmelidir.
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 10:23:38 GMT 2022.
 */
@DisplayName("C803 Excel bayi aktarımı yapılırken taxnumber 11 haneli olarak aktarım yapılabilmelidir.")
public class C803 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 13. Type 'BireyselCode001' in 'SearchVendorNameVN'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#SearchVendorName");
    ...
    // 14. Click '//div[contains(text(),'BireyselCode001')]'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    ...
    // 17. Is 'ilkSatır BireyselCode001' visible?
    by = By.xpath("//tr[1]/td[. = 'BireyselCode001']");
    driver.findElement(by).isDisplayed();

    // 18. Click 'Kullanıcı Silme'
    ...
    // 21. Does 'Gösterilecek Kayıt Bulunamadı.2' contain 'Gösterilecek Kayıt Bulunamadı.'?
    ...
    // 22. Clear 'SearchVendorNameVN' contents
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).clear();

    // 23. Type 'KurumsalCode001' in 'SearchVendorNameVN'
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).sendKeys("KurumsalCode001");

    // 24. Click '//div[contains(text(),'KurumsalCode001')]'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    ...
    // 29. Does 'Gösterilecek Kayıt Bulunamadı.2' contain 'Gösterilecek Kayıt Bulunamadı.'?
    by = By.xpath("//div[3]/div/table//td[. = 'Gösterilecek Kayıt Bulunamadı.']");
    Assertions.assertTrue(driver.findElement(by).getText().contains("Gösterilecek Kayıt Bulunamadı."));

    // 30. Clear 'SearchVendorNameVN' contents
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).clear();

    // 31. Type 'KurumsalCode002' in 'SearchVendorNameVN'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    by = By.cssSelector("#SearchVendorName");
    ...
    // 32. Click '//div[contains(text(),'KurumsalCode002')]'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    ...
    // 35. Does 'Entity.TaxNumber' contain '21212121212'?
    by = By.cssSelector("#Entity_TaxNumber");
    Assertions.assertTrue(driver.findElement(by).getText().contains("21212121212"));
    ...
    // 40. Does 'Gösterilecek Kayıt Bulunamadı.2' contain 'Gösterilecek Kayıt Bulunamadı.'?
