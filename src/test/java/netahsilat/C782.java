 ...
 * Test: C782 Email orderda gönderilen açıklamanın ödeme ekranında ve işlem sonrasında detayda olması
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 07:45:43 GMT 2022.
 */
@DisplayName("C782 Email orderda gönderilen açıklamanın ödeme ekranında ve işlem sonrasında detayda olması")
public class C782 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String mail, String url)
    ...
    // 2. Delete All Mails
    //    netahsilatlimitli2@yandex.com
    // Kd!cyhz4
    GeneratedUtils.sleep(500);
    deleteAllMails = ImapMailOperations.deleteAllMails("netahsilatlimitli2@yandex.com",password);
    ...
    // 7. Type '16797722124' in 'VendorName'
    GeneratedUtils.sleep(500);
    ...
    // 13. Click 'strContinue1'
    GeneratedUtils.sleep(500);
    by = By.xpath("//button[2][. = 'strContinue']");
    driver.findElement(by).click();

    // 14. Type 'testotomasyonOG' in 'description1'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#description");
    driver.findElement(by).sendKeys("testotomasyonOG");
    ...
    // 17. Output searched string in specific mail
    GeneratedUtils.sleep(500);
    readSpecificsMail = ImapMailOperations.readSpecificsMail("netahsilatlimitli2@yandex.com",password,"testotomasyonOG","C:\\TestProject\\mail\\email.html");
