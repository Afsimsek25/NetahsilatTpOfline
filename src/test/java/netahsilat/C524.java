 ...
 * Test: C524 Ödeme Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:47:49 GMT 2022.
 */
@DisplayName("C524 Ödeme Tipi İle Listeleme")
public class C524 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Tipi","Çek ile Ödeme","Contains");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 13. Select options in 'InstallmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 17. Select options in 'InstallmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Senet ile Ödeme");
    by = By.cssSelector("#InstallmentTypeId");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Ödeme Tipi","Senet ile Ödeme","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);
