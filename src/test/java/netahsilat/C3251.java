 ...
 * Generated on Sun Oct 09 19:34:40 GMT 2022.
 */
@DisplayName("C3251")
public class C3251 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String CurrentDate,
    ...
    // 14. Click 'EmailTypeSelection (Unchecked)'
    GeneratedUtils.sleep(500);
    ...
    // 16. Is 'İşleminiz başarıyla tamamlanmıştır' visible?
    GeneratedUtils.sleep(500);
    ...
    // 19. Move mouse to 'moveToIslemler'
    GeneratedUtils.sleep(500);
    ...
    // 21. Click 'KART KAYDETME LINKI LISTELEME1'
    GeneratedUtils.sleep(500);
    ...
    // 23. Get text from 'columnIslemDurumu'
    GeneratedUtils.sleep(500);
    ...
    // 25. Does 'İşlem İptal Edildi' contain 'İşlem İptal Edildi'?
    GeneratedUtils.sleep(500);
    ...
    // 26. Is 'islemİptalEdildiYenidenButton' not present or invisible?
    GeneratedUtils.sleep(500);
    ...
    // 36. Is 'Tarih Validate' present?
    GeneratedUtils.sleep(500);
    by = By.xpath("(//strong[text()='Geçerlilik Tarihi']/..//following::td)[1]");
    driver.findElement(by);

    // 37. Is ':Bi**** tü**** | n********n@y***com, ...' present?
    GeneratedUtils.sleep(500);
    by = By.xpath("//td[. = ':Bi**** tü**** | n********n@y***com, | ']");
    driver.findElement(by);
