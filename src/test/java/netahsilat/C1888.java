 ...
 * Test: C1888 Bayi - Çoklu Seçim Müşteri Temsilcisi Atama (Yeni Kayıt ve Kayıt Düzenleme (NTH-14633)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 08:35:15 GMT 2022.
 */
@DisplayName("C1888 Bayi - Çoklu Seçim Müşteri Temsilcisi Atama (Yeni Kayıt ve Kayıt Düzenleme (NTH-14633)")
public class C1888 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime) throws Exception {
    ...
    // 8. Type 'coklumusteritemsilcisi@c1888.bayi' in 'Yeni Bayi Tanımla E-Posta'
    by = By.cssSelector("#Masked_Email");
    driver.findElement(by).sendKeys("coklumusteritemsilcisi@c1888.bayi");

    // 9. Type 'C1888' in 'Bayi/Kullanıcı Adı 2'
    by = By.cssSelector("#Entity_Name");
    driver.findElement(by).sendKeys("C1888");

    // 10. Type '11111111110' in 'Vergi Numarası'
    by = By.cssSelector("#Entity_TaxNumber");
    driver.findElement(by).sendKeys("11111111110");

    // 11. Type 'Şişli' in 'Yeni Bayi Tanımla Vergi Dairesi'
    by = By.cssSelector("#Entity_TaxOffice");
    driver.findElement(by).sendKeys("Şişli");

    // 12. Type 'Site Admin Otomasyon2' in 'Müşteri Temsilcisi Textbox'
    by = By.xpath("//div[@id='tab-userinfo']//input[contains(@class, 'select2-input')]");
    driver.findElement(by).sendKeys("Site Admin Otomasyon2");

    // 13. Click 'Site Admin Otomasyon2'
    by = By.xpath("//span[. = 'Site Admin Otomasyon2']");
    driver.findElement(by).click();

    // 14. Type 'Site Müşteri Temsilcisi 1' in 'Müşteri Temsilcisi Textbox'
    by = By.xpath("//div[@id='tab-userinfo']//input[contains(@class, 'select2-input')]");
    driver.findElement(by).sendKeys("Site Müşteri Temsilcisi 1");

    // 15. Click 'Site Müşteri Temsilcisi 1'
    ...
    // 21. Type 'coklumusteritemsilcisi@c1888.bayi' in 'SearchVendorName'
    ...
    // 36. Is 'admin@netahsilat.com test' visible?
    by = By.xpath("//div[. = 'admin@netahsilat.com test']");
    driver.findElement(by).isDisplayed();

    // 37. Is 'otomasyon test1' visible?
    ...
    // 39. Click 'C1888 Trash.png'
    by = By.xpath("//td[contains(text(),'C1888')]//..//img[contains(@src,'trash.png')]");
    driver.findElement(by).click();
