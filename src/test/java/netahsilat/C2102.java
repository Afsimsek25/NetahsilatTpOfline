 ...
 * Test: C2102 Ödeme Talimat Formu - Alt Bayi
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 11:15:50 GMT 2022.
 */
@DisplayName("C2102 Ödeme Talimat Formu - Alt Bayi")
public class C2102 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String kartNo, String CVV,
    ...
    // 7. Click 'Alt bayi (Unchecked) - Ödeme Talimat Formu' if it's visible
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
    ...
    // 21. Click 'Alt bayi (Checked) - Ödeme Talimat Formu'
    ...
    // 41. Does 'Bireysel Alt Bayi (Silmeyiniz-Değişti...3' contain 'Bireysel Alt Bayi (Silmeyiniz-Değiştirmeyiniz)'?
    by = By.xpath("//strong[2][. = 'Bireysel Alt Bayi (Silmeyiniz-Değiştirmeyiniz)']");
