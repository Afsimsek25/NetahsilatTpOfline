 ...
 * Test: C2009 Ön bilgilendirme formu, Müşteri parametresi aktif/pasif kontrolü
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Fri Oct 07 11:17:02 GMT 2022.
 */
@DisplayName("C2009 Ön bilgilendirme formu, Müşteri parametresi aktif/pasif kontrolü")
public class C2009 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 15. Is 'Spinner (Loading)' not present or invisible?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    ...
    // 21. Is 'Müşteri (Unchecked)' visible?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);
    ...
    // 22. Click 'Müşteri (Unchecked)' if it's visible
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(15000, TimeUnit.MILLISECONDS);
    ...
    // 27. Is 'ön bilgilendirme formu body' not present or invisible?
    // set step-specific timeout (will undo this at the end)
