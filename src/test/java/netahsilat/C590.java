 ...
 * Test: C590 Bayi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 08:13:45 GMT 2022.
 */
@DisplayName("C590 Bayi İle Listeleme")
public class C590 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 8. Type 'Bireysel Ana Bayi' in 'VendorName'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#VendorName");
    driver.findElement(by).sendKeys("Bireysel Ana Bayi");

    // 9. Click 'Bireysel Ana Bayi (Silmeyiniz-Değişti...1'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ui-id-32");
    driver.findElement(by).click();
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Bayi/Kullanıcı Adı","Bireysel Ana Bayi (Silmeyiniz-","Contains");
