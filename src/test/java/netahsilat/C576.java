 ...
 * Test: C576 Gönderim Tipi İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Wed Oct 05 09:23:22 GMT 2022.
 */
@DisplayName("C576 Gönderim Tipi İle Listeleme")
public class C576 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 8. Select options in 'CommunicationType' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Email");
    by = By.cssSelector("#CommunicationType");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Gönderim Tipi","Email","Equals");
    getData = (GridOperations.GetData)((ReportingDriver)driver).addons().execute(getData);

    // 12. Select options in 'CommunicationType' with text '[NONE]'
    GeneratedUtils.sleep(500);
    selectOptionbyVisibleText = WebExtensions.selectOptionbyVisibleText("Sms");
    by = By.cssSelector("#CommunicationType");
    selectOptionbyVisibleText = (WebExtensions.SelectOptionbyVisibleText)((ReportingDriver)driver).addons().execute(selectOptionbyVisibleText, by, -1);
    ...
    // 15. 'Gösterilecek Kayıt Bulunamadı.1' contains text 'Gösterilecek Kayıt Bulunamadı.'?
    GeneratedUtils.sleep(500);
