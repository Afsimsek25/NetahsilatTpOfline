 ...
 * Test: C519 Çek Numarası İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Tue Oct 04 06:46:09 GMT 2022.
 */
@DisplayName("C519 Çek Numarası İle Listeleme")
public class C519 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 9. Is 'ChequeNumber' visible?
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ChequeNumber");
    driver.findElement(by).isDisplayed();

    // 10. Type '1234' in 'ChequeNumber'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#ChequeNumber");
    ...
    GeneratedUtils.sleep(500);
    getData = GridOperations.getData("Çek Numarası","1234","Equals");
