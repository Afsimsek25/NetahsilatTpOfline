 ...
 * Test: C467 Ödeme Şekli İle Listeleme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 03 21:00:38 GMT 2022.
 */
@DisplayName("C467 Ödeme Şekli İle Listeleme")
public class C467 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password) throws Exception {
    ...
    // 7. Select options in 'SelectedInstalmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    // 11. Select options in 'SelectedInstalmentTypeId' with text '[NONE]'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    kartKaydi = GetDataFromGridWithSpecificLocator.kartKaydi("div[class='t-widget t-grid'][id='VPosTransactionDetailBankPaymentGrid']","Taksit",0,1,">1");
