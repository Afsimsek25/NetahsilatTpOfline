 ...
 * Test: C1850 Bayi Limit Kullanımı Varken Bayi giriş yapıp limit dahilinde üyeliksiz email order ile ödeme yapabilmeli
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 09:02:49 GMT 2022.
 */
@DisplayName("C1850 Bayi Limit Kullanımı Varken Bayi giriş yapıp limit dahilinde üyeliksiz email order ile ödeme yapabilmeli")
public class C1850 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String email,
    ...
    // 4. Click 'SendSMS' if it's visible
    GeneratedUtils.sleep(500);
    ...
    // 6. Type '2' in 'PureAmount'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#PureAmount");
    driver.findElement(by).sendKeys("2");

    // 7. Generate random number between '[NONE]' and '999999999'
    GeneratedUtils.sleep(500);
    ...
    // 8. Type '{{islemNo}}' in 'ReferenceNumber'
    GeneratedUtils.sleep(500);
    ...
    // 10. Type '{{customerID}}' in 'CustomerId'
    GeneratedUtils.sleep(500);
    ...
    // 18. Type 'e-mail order deneme' in 'Description'
    GeneratedUtils.sleep(500);
    ...
    GeneratedUtils.sleep(500);
    readSpecificsMail = ImapMailOperations.readSpecificsMail(ProjectParameters.odemeEmail,ProjectParameters.yandexMailKey,islemNo,"C:\\TestProject\\mail\\C1850.html");
    readSpecificsMail = (ImapMailOperations.ReadSpecificsMail)((ReportingDriver)driver).addons().execute(readSpecificsMail);

    // 22. Navigate to 'file:///C:/TestProject/mail/C1850.html'
    GeneratedUtils.sleep(500);
    driver.navigate().to("file:///C:/TestProject/mail/C1850.html");
    ...
    // 29. Does 'txtReferansNumarasi' contain 'Referans Numarası'?
