 ...
 * Test: C1561 Bayi Haklarına ödeme yapabilir seçeneği eklenmesi (NTH-11357)
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Thu Oct 06 12:26:15 GMT 2022.
 */
@DisplayName("C1561 Bayi Haklarına ödeme yapabilir seçeneği eklenmesi (NTH-11357)")
public class C1561 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String userName, String password, String randomERP) throws
    ...
    // 5. Type '76162482466' in 'SearchVendorNameVN'
    GeneratedUtils.sleep(500);
    ...
    // 13. Click 'Ödeme yapabilir Checked İse' if it's visible
    GeneratedUtils.sleep(500);
    clickIfVisibleWeb = VisibleElementsOperations.clickIfVisibleWeb("");
    by = By.xpath("//label[normalize-space()='Ödeme yapabilir']/..//span[@class='jquery-safari-checkbox jquery-safari-checkbox-checked']");
    ...
    // 17. Is 'ONLINE ÖDEME' visible?
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
    try {
      by = By.xpath("//a[.='ONLINE ÖDEME']");
      driver.findElement(by).isDisplayed();
      Assertions.fail("Step 'Is 'ONLINE ÖDEME' visible?' result inverted, step failed");
    }
    ...
    // 22. Type '76162482466' in 'SearchVendorNameVN'
    GeneratedUtils.sleep(500);
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).sendKeys("76162482466");

    // 23. Click 'Bireysel Ana Bayi'
    GeneratedUtils.sleep(500);
    by = By.xpath("//div[contains(text(),'76162482466')]  ");
    driver.findElement(by).click();
    ...
    // 29. Click 'Ödeme yapabilir Non Checked İse' if it's visible
    GeneratedUtils.sleep(500);
    clickIfVisibleWeb = VisibleElementsOperations.clickIfVisibleWeb("");
    by = By.xpath("//label[normalize-space()='Ödeme yapabilir']/..//span[@class='jquery-safari-checkbox']");
    clickIfVisibleWeb = (VisibleElementsOperations.ClickIfVisibleWeb)((ReportingDriver)driver).addons().execute(clickIfVisibleWeb, by, -1);
