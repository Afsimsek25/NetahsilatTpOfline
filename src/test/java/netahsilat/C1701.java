 ...
 * Test: C1701 Bayiye üyelikli email order gönderme
 * Generated by: Ahmet Furkan SIMSEK (furkan.simsek@qualitymuseum.com)
 * Generated on Mon Oct 10 07:21:38 GMT 2022.
 */
@DisplayName("C1701 Bayiye üyelikli email order gönderme")
public class C1701 implements ExceptionsReporter {
  ...
  void execute(String ApplicationURL, String password, String currentDateTime, String RandomTutar1,
    ...
    // 2. Delete All Mails
    deleteAllMails = ImapMailOperations.deleteAllMails("altbayipos@yandex.com",password);
    deleteAllMails = (ImapMailOperations.DeleteAllMails)((ReportingDriver)driver).addons().execute(deleteAllMails);
    ...
    // 8. Type 'altbayipos@yandex.com' in 'SearchVendorName'
    by = By.cssSelector("#SearchVendorName");
    driver.findElement(by).sendKeys("altbayipos@yandex.com");
    ...
    // 15. Is 'PureAmount' visible?
    by = By.cssSelector("#PureAmount");
    driver.findElement(by).isDisplayed();

    // 16. Select options in 'PaymentSetId' with text '[NONE]'
    ...
    */
    // 22. Type 'netahsilatotomasyon@yandex.com' in 'send-otp-via-mfs-input'
    /* Step is disabled
    ...
    */
    ...
    driver.findElement(by).click();
    */
    // 24. Type 'C1701' in 'Description'
    by = By.cssSelector("#Description");
    driver.findElement(by).sendKeys("C1701");
    ...
    readSpecificsMail = ImapMailOperations.readSpecificsMail("altbayipos@yandex.com",password,Tutar,"C:/TestProject/mail/C1701.html");
    readSpecificsMail = (ImapMailOperations.ReadSpecificsMail)((ReportingDriver)driver).addons().execute(readSpecificsMail);

    // 28. Navigate to 'file:///C:/TestProject/mail/C1701.html'
    driver.navigate().to("file:///C:/TestProject/mail/C1701.html");

    // 29. Get 'href' attribute value on 'Ödeme yapmak için lütfen tıklayınız'
    ...
    // 32. Click 'Vakıfbank Tek Çekim Posu'
    by = By.cssSelector("td[class*='commRate-4050'] input");
    driver.findElement(by).click();

    // 33. Click 'btnNormalPayment'
    by = By.cssSelector("#btnNormalPayment");
    driver.findElement(by).click();

    // 34. Is 'Payment Efekti' visible?
    by = By.cssSelector("div[class='spinner']");
    driver.findElement(by).isDisplayed();

    // 35. Get text from 'txtReferansNumarasi'
    // set step-specific timeout (will undo this at the end)
    driver.manage().timeouts().implicitlyWait(35000, TimeUnit.MILLISECONDS);
    ...
    // 36. Get substring of '{{ReferansNumber}}' from '42' to '[NONE]'
    ...
    // 37. Run Method Vakıfbank İşlem Durumu Sorgulama
